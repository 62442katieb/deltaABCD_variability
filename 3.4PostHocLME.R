...
tab_model(thk_lm, digits = 4, file=paste(PROJ_DIR,
                             OUTP_DIR,
                             'thk-sa_corr-results-female.html',
                             sep = "/",
                             collapse = NULL))
# male ppts only
thk_lm <- lm('r ~ base_puberty + y2fu_puberty + interview_age + race_ethnicity_bl + highest_parent_educ_bl + household_income_4bins_tp + site_id_l',
...
tab_model(thk_lm, digits = 4, file=paste(PROJ_DIR,
                                         OUTP_DIR,
                                         'rni-sa_corr-results-female.html',
                                         sep = "/",
                                         collapse = NULL))
# male ppts only
thk_lm <- lm('r ~ base_puberty + y2fu_puberty + interview_age + race_ethnicity_bl + highest_parent_educ_bl + household_income_4bins_tp + site_id_l',
...
tab_model(thk_lm, digits = 4, file=paste(PROJ_DIR,
                                         OUTP_DIR,
                                         'rnd-sa_corr-results-female.html',
                                         sep = "/",
                                         collapse = NULL))
# male ppts only
thk_lm <- lm('r ~ base_puberty + y2fu_puberty + interview_age + race_ethnicity_bl + highest_parent_educ_bl + household_income_4bins_tp + site_id_l',
...
tab_model(thk_lm, digits = 4, file=paste(PROJ_DIR,
                                         OUTP_DIR,
                                         'var-sa_corr-results-female.html',
                                         sep = "/",
                                         collapse = NULL))
# male ppts only
thk_lm <- lm('r ~ base_puberty + y2fu_puberty + interview_age + race_ethnicity_bl + highest_parent_educ_bl + household_income_4bins_tp + site_id_l',
...
tab_model(thk_lm, digits = 4, file=paste(PROJ_DIR,
                                         OUTP_DIR,
                                         'var-sa_corr-results-male.html',
                                         sep = "/",
                                         collapse = NULL))
write.csv(model_stats, paste(PROJ_DIR, OUTP_DIR, 'sa_corr-lm_model-stats.csv', sep='/'))