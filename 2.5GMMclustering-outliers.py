...
outliers = pd.read_pickle(join(PROJ_DIR, OUTP_DIR, 'brain_outliers.pkl'))
outlier_ppts = outliers[outliers < 1].index

print(len(outlier_ppts))
df = df.drop(outlier_ppts, axis=0)
